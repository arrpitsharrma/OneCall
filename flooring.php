...
{
    if (array_key_exists("flooring",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $new_value=$data['flooring']+1;
        setcookie('services[flooring]',$new_value);
    }
    else
    {
        setcookie('services[flooring]',1);
    }
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Flooring';
...
?>
<html><title>Flooring</title><head>
...
<h1 style="margin-right: 14px;">Flooring</h1>
</head>
<body bgcolor="black" text="white" style="text-align: center; background-image: url(bg.jpg);
  background-repeat: repeat-x;">

<p style="margin-left: 175px;">
OneCall floor services are your total solution for installation and repair of most types of 
flooring, including hardwood, laminate, ceramic tile and more. All of our home improvement professionals
are experienced and insured. You can count on your local Mr. OneCall for a one-call, worry-free 
solution to all of your flooring projects.<br><br>
<img src="flooring_img.jpg" style="height: 400px"/>
</p>
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://mitwapalkhiwala.com/rest/showUserRating.php?email=".$email."&productName=Flooring",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Flooring",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
