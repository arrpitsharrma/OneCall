...
{
    if (array_key_exists("Plumbing",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Plumbing']+1;
        setcookie('services[Plumbing]',$newValue);
    }
    else
    {
        setcookie('services[Plumbing]',1);
    }
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Plumbing';
...
?>
<html><title>Plumbing</title><head>
...
<h1 style="margin-right: 14px;">Plumbing</h1>
</head>
<body bgcolor="black" text="white" style="text-align: center; background-image: url(bg.jpg);
  background-repeat: repeat-x;">

<p style="margin-left: 175px;">
Hi-tech equipments for repiping using copper for your 
home
<br>Also specialize in trenchless line replacements
<br> All new customers receive additional discounts up to 15 % off repiping,trenchless in San Jose 
<br><br>
<img src="plumbing_img.webp" style="height: 400px"/>
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://mitwapalkhiwala.com/rest/showUserRating.php?email=".$email."&productName=Plumbing",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Plumbing",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
