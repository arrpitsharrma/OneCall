...
{
    if (array_key_exists("Lawncare&Sprinklers",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $new_value=$data['Lawncare&Sprinklers']+1;
        setcookie('services[Lawncare&Sprinklers]',$new_value);
    }
    else
    {
        setcookie('services[Lawncare&Sprinklers]',1);
    }
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Lawncare';
...
?>
<html><title>Lawncare and Sprinklers</title><head>
...
<h1 style="margin-right: 14px;">Lawncare and Sprinklers</h1>
</head>
<body bgcolor="black" text="white" style="text-align: center; background-image: url(bg.jpg);
  background-repeat: repeat-x;">

<p style="margin-left: 175px;">
Do you have a broken sprinkler head? Or will your sprinkler system not come on at all? 
No matter the issue, OneCall Irrigation is equipped to handle all sprinkler repairs in the San Jose, CA
 area. Our technicians are the best when it comes to troubleshooting and coming up with the most 
 cost-effective solution to bring your sprinkler system up to its maximum efficiency. With the dry 
 conditions in San Jose, California, drought damage can take its toll on turf
 in a matter of days so getting your system repaired quickly is important.
<br><br>
<img src="lawncare_img.jpg" style="height: 400px"/>
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://mitwapalkhiwala.com/rest/showUserRating.php?email=".$email."&productName=Lawncare",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Lawncare",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
