...
{
    if (array_key_exists("CeilingFixes",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['CeilingFixes']+1;
        setcookie('services[CeilingFixes]',$newValue);
    }
    else
    {
        setcookie('services[CeilingFixes]',1);
    }
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Ceiling';
...
?>
<html><title>Ceiling Fixes</title><head>
...
<h1 style="margin-right: 14px;">Ceiling Fixes</h1>
</head>
<body bgcolor="black" text="white" style="text-align: center; background-image: url(bg.jpg);
  background-repeat: repeat-x;">

<p style="margin-left: 175px;">
The ceiling plays an important role in comfort control. A busy ceiling can cause the room 
to feel cramped while a dimly lit room can make the room seem drab. Nobody knows this better 
than our experienced team of ceiling professionals. Whether you want to install new pendant 
lights or a brand new fan, our workmanship is guaranteed.
<br><br> 
Whether you need to remove, replace or install a ceiling fan, Mr. OneCall is your convenient, 
one-call solution. Your comfort, and satisfaction, is guaranteed. Our professionals are also capable
 of replacing your old ceiling fan with a light fixture of your choice. 
Contact your local Mr. OneCall for help planning and completing your next ceiling fan project. 
<br><br>
<img src="ceiling_img.jpg" style="height: 400px"/>
</p>
<button onclick="getInput()">click Here to rate this product</button>
    <?php
        if(isset($_POST['review'])){
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://mitwapalkhiwala.com/rest/showUserRating.php?email=".$email."&productName=Ceiling",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Ceiling",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
