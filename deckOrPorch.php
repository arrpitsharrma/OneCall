...
{
    if (array_key_exists("DeckOrPorch",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $new_value=$data['DeckOrPorch']+1;
        setcookie('services[DeckOrPorch]',$new_value);
    }
    else
    {
        setcookie('services[DeckOrPorch]',1);
    }
...
$curl = curl_init();
    ...
    $array1['productName']='Deck or Porch';
...
if (isset($_POST['review'])) {
        ...
        $array1_new['productName']='Deck or Porch';
...
<html><title>Deck or Porch</title><head>
...
<h1 style="margin-right: 14px;">Deck or Porch</h1>
</head>
<body bgcolor="black" text="white" style="text-align: center; background-image: url(bg.jpg);
  background-repeat: repeat-x;">

<p style="margin-left: 175px;">
A deck from a OneCall will add beauty to your home and value 
to your life. 
It can be just the place to host a neighborhood get together or simply the perfect place to 
sit back and relax. We build and customize your deck so that they blend in with your present home 
design and terrain.

Our professionals will advise you on design and material choices as well as come out to your
 home to get a sense of what you want in the context of what is possible for your space.
<br><br>
<img src="deckOrPorch_img.jpg" style="height: 400px"/>
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://mitwapalkhiwala.com/rest/showUserRating.php?email=".$email."&productName=Deck%20or%20Porch",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
$curl = curl_init();
curl_setopt_array($curl, array(
    CURLOPT_URL => "http://www.mitwapalkhiwala.com/rest/ratings_reviews.php?productName=Deck%20or%20Porch",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
